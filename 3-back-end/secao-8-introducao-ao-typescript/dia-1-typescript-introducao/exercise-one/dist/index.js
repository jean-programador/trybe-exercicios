...
console.log(`-  B = 100cm, b = 70cm e altura = 50cm: ${Ex.getTrapezioArea(100, 70, 50)}`);
console.log(`-  B = 75cm, b = 50cm e altura = 35cm: ${Ex.getTrapezioArea(75, 50, 35)}`);
console.log(`- B = 150cm, b = 120cm e altura = 80cm: ${Ex.getTrapezioArea(150, 120, 80)}`);
